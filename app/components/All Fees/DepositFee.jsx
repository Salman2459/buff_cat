  ...
  return (
    <>
      ...
      <div className="flex font-[16px] gap-2 mt-8 jost">
        ...
        <p className='text-white md:pr-10 text-[.8em] '>For deposits under $1,000, the user pays a 0.5% fee, with a minimum of $5. As the deposit amount increases, the percentage decreases, but larger deposits might incur a higher minimum fee.</p>
      </div>
    </>
