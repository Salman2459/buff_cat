...
export const Coinreward = () => {
  return (
    ...
    Claim Rewards
        ...
        <p className='text-[#fff] text-[18px] font-bold'>Total Claim Rewards</p>
        <p className='text-[#fff] text-[24px] font-bold '>$456.78</p>

        </div>
       
        <div className='flex justify-around items-center mt-1'>
        <p className='text-[#fff] text-[18px]  font-bold'>Rewards Claimed</p>
        <p className='text-[#fff] text-[24px] font-bold'>$456.78</p>
        ...
        <input
              type="text"
              className="w-[70%] bg-[#F3933F30] rounded-xl h-[50px] px-4"
