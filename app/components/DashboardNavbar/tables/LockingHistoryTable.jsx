...
<<<<<<< HEAD
            <tr className=" border-b border-gray-700 text-center">
              ...
              <th className="py-2 px-4 text-[19px] font-bold">Start Date</th>
              <th className="py-2 px-4 text-[19px] font-bold">End Date</th>
              <th className="py-2 px-4 text-[19px] font-bold">Status</th>
...
>>>>>>> 17a503cc4e0f1178ccfb9c29959c286746afe87d
          ...
          <tbody>
            {data.lockingHistory.map((item, index) => (
              <tr key={index} className="border-b border-[#6A6A6A] text-center h-[60px] ">
                <td className="py-2 px-4 flex items-center">
                  <img className="w-[25px] h-[25px] mr-1" src="./eth.png" alt="ETH Logo" />
                  <p className="Jost text-[19px] font-medium ml-3">{item.name}</p>
                </td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.amountLocked}</td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.startDate}</td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.endDate}</td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">
                  <span className="bg-green-500 text-white px-3 py-1 rounded-[50px]">{item.status}</span>
                </td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.duration}</td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.hashId}</td>
                <td className="py-2 px-4 Jost text-[19px] font-medium">{item.autoCompound}</td>
              </tr>
            ))}
          </tbody>
        </table>
