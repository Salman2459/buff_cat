        ...
        <div className='  w-full'>
            <div className="flex flex-col lg:flex-row justify-between items-center p-4 bg-[#170A05] w-[100%] border-b-[2px] border-[#AEAEAE]">
                ...
                <div className="w-full lg:w-[430px] lg:flex items-center space-x-4 flex-col lg:flex-row">
                    ...
                    <Link href={'/'} className='w-full flex justify-center'>  <button className="lg:ml-5 bg-gradient-to-r from-[#EFCB97] to-[#F3933F] w-[80%] lg:w-[120px] lg:h-[45px] rounded-lg text-white text-lg font-semibold  py-2 relative -left-3 lg:left-0" >Logout</button></Link>
                    </div>
                </div>
            </div>
        </div>
