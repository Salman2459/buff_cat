    ...
    <div >
      ...
      {navopen ? <div className='w-[90%] md:w-[80%] bg-gradient-to-r from-[#EFCB97] to-[#F3933F] h-auto absolute z-10 top-[105px] left-1/2 -translate-x-1/2'>
        <ol className='cursor-pointer'>
          ...
          <li className={navigationTABS == 'Localtoken' ? 'text-center mt-5 font-medium text-[1.2em] text-black' : 'text-center mt-5 font-medium text-[1.2em] text-white'} onClick={() => ChangeTab('Localtoken')}>Lock</li>
          ...
          <li className={navigationTABS == 'trendingtoken' ? 'text-center mt-5 font-medium text-[1.2em] text-black' : 'text-center mt-5 font-medium text-[1.2em] text-white'} onClick={() => ChangeTab('trendingtoken')}>Trending</li>
