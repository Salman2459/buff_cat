  ...
  return (
    <div className='bg-[#291B0E] mt-10'>
      <div className='flex'>
        ...
        <div className='flex-1 flex justify-center mt-5 text-white items-center'><Link href={'https://x.com/BuffCatOfficial'}><img src='./mainX.png' className='w-[30px] h-[30px] bg-white rounded-lg' /></Link></div>
